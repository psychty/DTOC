...
if (!file.exists("./Delayed Transfers of Care/DToC_Days_Responsible_Organisation_created_January_2019.csv")) {
source("./Delayed Transfers of Care/Delayed Transfers of Care data collation.R")}

Days_organisation <- read_csv("./Delayed Transfers of Care/DToC_Days_Responsible_Organisation_created_January_2019.csv",col_types = cols(Name = col_character(),NHS = col_integer(),`Social Care` = col_integer(),Both = col_integer(),Total = col_integer(),Period_year = col_character())) %>% 
